...
/// @title Contract for Convex strategy implementation
/// @author vpomo
abstract contract ConvexStrategyBase is StrategyBase {
  using SafeERC20 for IERC20;

  IStrategy.Platform private constant _PLATFORM = IStrategy.Platform.CONVEX;
  ...
  string public constant override STRATEGY_NAME = "ConvexStrategyBase";
  ...
  function autocompoundConvex() internal {
    for (uint256 i = 0; i < _rewardTokens.length; i++) {
