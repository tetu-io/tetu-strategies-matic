...
/// @notice Restored from 0x929ec64c34a17401f460460d4b9390518e5b473 (events were removed)
/// @dev See aave-v3-periphery, file IRewardsDistributor.sol
interface IAave3RewardsController {
   ...
   * @return rewardsList The list of reward addresses
   * @return unclaimedAmounts The list of unclaimed amount of rewards
   **/
