...
// !!!!!!!!!!!!!!!!!!!!!!!! CHANGE ME !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
const POLYGON_SNAPSHOT_BLOCK_NUMBER = 53761171; // use the-best-block-for-snapshot.ts script
const START_UNIX = Math.floor(Date.now() / 1000)
const END_UNIX = Math.floor((new Date('Mar 04 2024 20:00:00 UTC')).getTime() / 1000)
const TITLE = 'BRV-041: Gauge Weights for 07th March - 20th March 2024'
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
