...
// !!!!!!!!!!!!!!!!!!!!!!!! CHANGE ME !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
const POLYGON_SNAPSHOT_BLOCK_NUMBER = 52188265; // use the-best-block-for-snapshot.ts script
const START_UNIX = Math.floor(Date.now() / 1000)
const END_UNIX = Math.floor((new Date('Jan 22 2024 20:00:00 UTC')).getTime() / 1000)
const TITLE = 'BRV-038: Gauge Weights for 25th January - 07th February 2024'
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
