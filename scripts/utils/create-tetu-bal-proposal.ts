...
const POLYGON_SNAPSHOT_BLOCK_NUMBER = 44811103
const START_UNIX = Math.floor((new Date('Jul 20 2023 19:00:00 UTC')).getTime() / 1000)
const END_UNIX = Math.floor((new Date('Jul 25 2023 03:00:00 UTC')).getTime() / 1000)
...
const TITLE = 'BRV-025: Gauge Weights for 26th July - 09th August 2023'
