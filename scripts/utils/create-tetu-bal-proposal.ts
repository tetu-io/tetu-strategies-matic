...
// !!!!!!!!!!!!!!!!!!!!!!!! CHANGE ME !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
const POLYGON_SNAPSHOT_BLOCK_NUMBER = 54412207; // use the-best-block-for-snapshot.ts script
const START_UNIX = Math.floor(Date.now() / 1000)
const END_UNIX = Math.floor((new Date('Mar 18 2024 20:00:00 UTC')).getTime() / 1000)
const TITLE = 'BRV-042: Gauge Weights for 21th March - 03th April 2024'
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
