...
import {IRewardToken, IstKlima} from "../../../../typechain";
...
export class KlimaStakingDoHardWork extends DoHardWorkLoopBase {
  ...
  public async loopStartActions(i: number) {
    ...
    const klimaCtr = await DeployerUtils.connectInterface(treasury, 'IRewardToken', MaticAddresses.KLIMA_TOKEN) as IRewardToken;
