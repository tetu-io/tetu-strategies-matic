...
import {IstKlima, IRewardToken} from "../../../../typechain";
...
export class VesqStakingDoHardWork extends DoHardWorkLoopBase {
  ...
  public async loopStartActions(i: number) {
    ...
    const klimaCtr = await DeployerUtils.connectInterface(treasury, 'IRewardToken', MaticAddresses.VSQ_TOKEN) as IRewardToken;
