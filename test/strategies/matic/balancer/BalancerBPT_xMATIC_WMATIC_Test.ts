...
describe.skip('BalancerBPT_xMATIC_WMATIC_Test', async () => {
  ...
  const underlying = MaticAddresses.BALANCER_xMATIC_MATIC;
  const poolId = MaticAddresses.BALANCER_xMATIC_MATIC_ID;
  const gauge = MaticAddresses.BALANCER_xMATIC_MATIC_GAUGE;
  const depositToken = MaticAddresses.WMATIC_TOKEN;
